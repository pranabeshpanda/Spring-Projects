...
import com.motocart.shoppingcart.util.Utils;
import com.motocart.shoppingcart.validator.CustomerInfoValidator;
...
@EnableWebMvc
public class MotoCartMainController {
	...
	public String shoppingCartConfirmationSave(HttpServletRequest request, Model model) {
		...
		try {
			transactionDAO.saveTransaction(cartInfo);
		} catch (Exception e) {
