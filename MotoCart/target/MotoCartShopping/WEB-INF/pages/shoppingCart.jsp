...
<body>
	...
	<c:if test="${empty cartForm or empty cartForm.cartLines}">
		<h2 class="body-order-list-title">There are no items in Cart</h2>
		<a href="${pageContext.request.contextPath}/productList" class="body-order-list-title">Show Product List</a>
	</c:if>
			...
			<c:forEach items="${cartForm.cartLines}" var="cartLineInfo"	varStatus="varStatus">
				<div class="product-preview-container">
					<ul>
						...
						<li class="body-my-cart">Quantity: <form:input
								path="cartLines[${varStatus.index}].quantity" /></li>
						<li class="body-my-cart">Subtotal: <span class="subtotal">

								<fmt:formatNumber value="${cartLineInfo.amount}" type="currency" />

						</span>
						</li>
						<li class="body-my-cart"><a
